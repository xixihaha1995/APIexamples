...
parser = argparse.ArgumentParser(description='This script will run EnergyPlus by API twice, in two different threads, clearing the state in between')
parser.add_argument('folder_with_pyenergyplus', help='This is the path to a folder, which itself contains a pyenergyplus folder')
parser.add_argument('path_to_idf', help='This is the absolute path to the IDF to run twice')
